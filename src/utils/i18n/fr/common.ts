const common = {
  ...
  common: {
    ...
    a11y: {
      ...
      appLogo: "Logo MyTripCircle",
      actionsFor: "Actions pour {{item}}",
      editItem: "Modifier {{item}}",
      deleteItem: "Supprimer {{item}}",
      close: "Fermer",
      clearSearch: "Effacer la recherche",
      removeSearchHistoryItem: "Retirer « {{query}} » de l'historique de recherche",
      decreaseDays: "Retirer un jour",
      increaseDays: "Ajouter un jour",
      previousMonth: "Mois précédent",
      nextMonth: "Mois suivant",
      toggleSatelliteView: "Basculer la vue satellite",
