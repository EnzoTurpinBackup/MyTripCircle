const common = {
  ...
  common: {
    ...
    a11y: {
      ...
      appLogo: "MyTripCircle logo",
      actionsFor: "Actions for {{item}}",
      editItem: "Edit {{item}}",
      deleteItem: "Delete {{item}}",
      close: "Close",
      clearSearch: "Clear search",
      removeSearchHistoryItem: "Remove \"{{query}}\" from search history",
      decreaseDays: "Remove one day",
      increaseDays: "Add one day",
      previousMonth: "Previous month",
      nextMonth: "Next month",
      toggleSatelliteView: "Toggle satellite view",
